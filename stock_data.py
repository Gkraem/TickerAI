"""
Stock Database for Modern Ticker AI
Extracted from main app to avoid import conflicts
"""
...
POPULAR_STOCKS = [
    ...
    {"ticker": "PCG", "name": "Pacific Gas and Electric Company"},
...
def search_stocks(query):
    ...
    ticker_mappings = {
        ...
        "lockheed": "LMT",
        "raytheon": "RTX",
        "defense": ["NOC", "LMT", "GD", "RTX", "HII"],
        "airlines": ["AAL", "DAL", "UAL", "LUV"],
        "tech": ["AAPL", "MSFT", "GOOGL", "META", "AMZN", "NVDA"],
        "semiconductors": ["NVDA", "AMD", "INTC", "MU", "TSM", "AVGO"],
