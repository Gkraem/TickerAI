"""
Finance Tracker - Clean Modern Interface
Modern Streamlit interface matching the clean Finance Tracker design
"""
...
# Custom CSS for Finance Tracker styling
st.markdown("""
<style>
...
def render_header(is_authenticated=False, user_data=None):
    """Render Finance Tracker style header"""
    ...
    <div class="finance-header">
        <div class="logo-container">
            <div class="logo">📈</div>
            <h1 class="brand-name">Finance Tracker</h1>
        </div>
...
def render_welcome_section(user_name="User"):
    """Render welcome section matching Finance Tracker style"""
    welcome_html = f"""
